...
export default function TestPage() {
  ...
  return (
    ...
    <div>
      <Radio.Group onChange={handleModeChange} value={showPreviousEvents} style={{ marginBottom: 8 }}>
        <Radio.Button value={false}>Current Events</Radio.Button>
        <Radio.Button value={true} >Previous Events</Radio.Button>
      </Radio.Group>
      <Button type='primary' onClick={() => createEventFromToday()}>Create new Event</Button>
